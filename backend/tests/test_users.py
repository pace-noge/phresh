...
class TestUserLogin:
    async def test_user_login_successfully_and_receives_valid_token(
            self,
            app: FastAPI,
            client: AsyncClient,
            test_user: UserInDB
...
class TestUserMe:
    ...
    async def test_user_cannot_access_own_data_if_not_authentication(
